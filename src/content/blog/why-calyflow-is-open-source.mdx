...
Calyflow is an open-source recruiting OS that runs AI workflows on your own models, data, and tools — and the "open-source" part is not a distribution strategy, it's the product decision everything else follows from. The code is AGPL-3.0, the repo is public, and you can self-host the entire platform.
...
With a closed-source AI tool, the only available answer is "trust us." With open source, the answer is *"read the code"* — and even if you personally never will, your security team can, your enterprise client's auditors can, and the thousand other people looking at the repo effectively do it for you. Inspectability isn't a feature for engineers; it's what lets a recruiting agency answer a client's due-diligence questionnaire with documents instead of promises.
