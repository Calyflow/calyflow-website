...
Recruiting AI asks for deep trust: in what happens to candidates' data, to clients' briefs, and to your own operation. We don't think that trust should be a promise. Calyflow is open source so it can be a property, readable in the code, enforceable in the license, and exercisable the day you want to walk away. That's also, we'd argue, the only durable foundation for the [whole BYO architecture](/#principles).

*[Create a free account](https://app.calyflow.ai/sign-up) and run your first workflow: free to start, your own API key, no credit card.*
